...
//    private String conformationToken;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getId(), getUsername(), getFirstName(), getLastName(), getBirthDate(), getAge(), getGender(), getAddress(), getRegiDate(), getEmail(), getMobile(), getLastModifiedDate(), getPassword(), isStatus(), getRoles());
    }
