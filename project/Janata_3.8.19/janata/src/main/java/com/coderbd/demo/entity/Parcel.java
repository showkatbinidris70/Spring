...
public class Parcel {
    ...
    public Parcel(@NotNull @Size(min = 2, max = 30, message = "Hey, Size must be between 2 and 30") String parcelName, String weight, String height, String length, String productType, String sendCountry, String sendState, Date deliveryDate, Date bookingDate, Branch branch, Company company, ShippingDetails shippingDetails) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getId(), parcel.getId()) &&
                ...
                Objects.equals(getSendCountry(), parcel.getSendCountry()) &&
                Objects.equals(getSendState(), parcel.getSendState()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getId(), getParcelName(), getWeight(), getHeight(), getLength(), getProductType(), getSendCountry(), getSendState(), getDeliveryDate(), getBookingDate(), getBranch(), getCompany(), getShippingDetails());
    }
